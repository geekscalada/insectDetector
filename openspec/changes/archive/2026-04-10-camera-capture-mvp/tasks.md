...
- [x] 3.2 El nombre de fichero SHALL ser `YYYY-MM-DDTHH-MM-SS.ffffff.jpg` (`:` reemplazados por `-`, microsegundos incluidos para unicidad)
...
- [x] 5.1 Ejecutar `pip install -r requirements.txt` en la Pi
- [x] 5.2 Ejecutar `python main.py` en la Pi y comprobar que aparecen exactamente 5 ficheros JPEG en `detections/`
- [x] 5.3 Abrir uno de los JPEGs y confirmar que muestra imagen real de la cámara
